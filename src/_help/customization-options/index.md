...
Finally, you can define the method for [sorting API operations](/help/customization-options/operations-navigation/) to offer a comfortable and smooth reading experience. Instead of the default endpoints, webhooks or channels navigation, you can also replace it with [your own custom sections](/help/customization-options/sections/), defined directly from your OpenAPI or AsyncAPI document.
