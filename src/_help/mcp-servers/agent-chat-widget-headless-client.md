...
It's live on this page: hit the button below and ask it anything about the weather.

<div data-controller="agent"
     data-agent-endpoint-value="https://run.bump.sh/mcp-demo/weather-demo/agent"
     data-agent-title-value="Weather wizard 🪄"
     data-agent-placeholder-value="Ask anything about weather, and I'll find the right answer!"
     data-agent-theme-value='{"accent": "#025fd7", "bg": "#f9fafb"}'>
  <button type="button" data-action="agent#toggle">Ask the weather wizard</button>
</div>
