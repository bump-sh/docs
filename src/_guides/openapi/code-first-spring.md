...
```
# check for java. Anything above 21 is fine.
java --version
...
### Step 2: Start with some basic REST controllers
...
### Step 5: Improve OpenAPI with Java annotations
...
You can also add parameters and responses using the `@Parameter` and
...
This will add a parameter to the OpenAPI description for the `id` path variable,
including its description and type.
...
### Step 6: Deploy the improved OpenAPI description
