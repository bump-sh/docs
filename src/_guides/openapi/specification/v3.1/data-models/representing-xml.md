...
By combining [schema composition](./schema-composition.md) and [references](../advanced/splitting-documents-with-ref.md), it's possible to create reusable components that be used for both JSON and XML output, like this simplistic example below. 
