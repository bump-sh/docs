...
> Bump.sh now includes its own [API Explorer](/product-updates/2025/01/09/api-explorer/), allowing you to test your API directly within your documentation. [Give it a try!](https://bump.sh/demo/doc/api-explorer/explorer/operation/operation-adduser)
...
![Create your workspace view, with a list of templates that can be used for the workspace, "API demos" template is selected.](/docs/images/guides/try-requests-in-postman/postman-create-workspace.png)
...
!["New API" screen in Postman, showing "Quickstart your API by connecting a repository" and a list of options to connect GitHub, Bitbucket, GitLab SaaS, or Azure DevOps.](/docs/images/guides/try-requests-in-postman/postman-new-api.png)

Then you can configure which Git repository your API should be connected to.

!["Connect Repository" screen in Postman, with dropdowns for GitHub organization, Repository, and initial branch.](/docs/images/guides/try-requests-in-postman/postman-connect-repository.png)
...
![Postman source control view with some changes it wants to make, and a warning to commit to a branch as main branch is protected.](/docs/images/guides/try-requests-in-postman/postman-commit.png)
...
![Postman's API overview lists "Definitions" with the one we just added, and "Collections" which is empty, but has an option to Generate from definition](/docs/images/guides/try-requests-in-postman/generate-from-definition.png)
...
![Genereate from definition settings on their defaults, mainly Naming requests set to Fallback](/docs/images/guides/try-requests-in-postman/generate-modal.png)
...
![The API definition contains the collection, but it needs to be copied to Collections tab by right clicking and selecting Copy to collections](/docs/images/guides/try-requests-in-postman/copy-to-collections.png)
...
![Share modal, Via Run in Postman tab selected, with the Markdown friendly tab within that.](/docs/images/guides/try-requests-in-postman/postman-share-button.png)
...
![Back in the Bump.sh hosted API documentation we've added a "Run in Postman" section with the paragraph added in Markdown above, and the orange Run in Postman button showing](/docs/images/guides/try-requests-in-postman/bump-docs-postman-button.png)
...
![The view Postman users will get after clicking that button, with the Train Travel API example, and operation Get a list of train stations selected ready for HTTP requests](/docs/images/guides/try-requests-in-postman/postman-view.png)
