...
**Learn more about [source descriptions](_specifications/arazzo/v1.0/understanding-structure/defining-sources.md).**
...
**Learn more about [Workflows](_specifications/arazzo/v1.0/understanding-structure/workflows.md).**
...
**Learn more about [components and referencing](_specifications/arazzo/v1.0/understanding-structure/components-and-references.md).**
...
- [Defining sources](_specifications/arazzo/v1.0/understanding-structure/defining-sources.md) - How to reference API definitions
- [Workflows](_specifications/arazzo/v1.0/understanding-structure/workflows.md) - Creating workflow sequences  
- [Steps, inputs, and outputs](_specifications/arazzo/v1.0/understanding-structure/steps-inputs-outputs.md) - Working with data flow
- [Success and failure](_specifications/arazzo/v1.0/understanding-structure/success-and-failure.md) - Handling outcomes
- [Components & references](_specifications/arazzo/v1.0/understanding-structure/components-and-references.md) - Reusing definitions
