...
Learn more about success and failure actions in the [Success and failure](_specifications/arazzo/v1.0/understanding-structure/success-and-failure.md) guide.
