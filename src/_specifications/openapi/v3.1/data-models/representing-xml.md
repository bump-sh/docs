...
canonical_url: https://docs.bump.sh/openapi/v3.2/data-models/representing-xml/
date: 2024-07-24
---
...
By combining [schema composition](_specifications/openapi/v3.1/data-models/schema-composition.md) and [references](_specifications/openapi/v3.1/advanced/splitting-documents-with-ref.md), it's possible to create reusable components that be used for both JSON and XML output, like this simplistic example below.
