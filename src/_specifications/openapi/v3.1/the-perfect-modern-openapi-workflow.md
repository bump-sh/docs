...
authors: phil
canonical_url: https://docs.bump.sh/openapi/v3.2/the-perfect-modern-openapi-workflow/
excerpt: >
...
![](/docs/images/guides/the-perfect-modern-openapi-workflow/design-first-workflow.png)
...
![](/docs/images/guides/the-perfect-modern-openapi-workflow/vacuum-annotations.png)
...
![The Train Travel API documentation example on Bump.sh with a TypeScript SDK generated by Speakeasy showing in the documentation.](/docs/images/guides/the-perfect-modern-openapi-workflow/bump-sdks.png)
...
![A list of APIs, descriptions, and last updated times, for a sample Hub on Bump.sh](/docs/images/guides/the-perfect-modern-openapi-workflow/bump-hubs.png)
...
![](/docs/images/guides/the-perfect-modern-openapi-workflow/api-explorer-request.png)
