...
canonical_url: https://docs.bump.sh/openapi/v3.2/understanding-structure/http-requests/
date: 2024-07-09
---
...
If multiple properties could be updated, you would define all the properties that could be updated, then show off some [examples](_specifications/openapi/v3.1/data-models/examples.md) for common use-cases of things users might want to do.

## File Uploads & Multipart Forms

HTTP requests can also cover more advanced scenarios like [file uploads](_specifications/openapi/v3.1/advanced/file-uploads.md) and [multipart form data](_specifications/openapi/v3.1/advanced/multipart-form-data.md), which have their own guides in the advanced section.
