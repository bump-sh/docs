...
canonical_url: https://docs.bump.sh/openapi/v3.2/understanding-structure/components/
date: 2024-07-02
---
...
Hopefully this gives an idea of how `$ref` can be used, and if you'd like to learn more check out our advanced guide: [Splitting Documents with $ref](_specifications/openapi/v3.1/advanced/splitting-documents-with-ref.md).
