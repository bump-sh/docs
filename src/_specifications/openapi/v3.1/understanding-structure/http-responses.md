...
authors: phil
excerpt: 
canonical_url: https://docs.bump.sh/openapi/v3.2/understanding-structure/http-responses/
date: 2024-07-09
---
...
> These responses contain shared schemas which are referenced via the [components section](_specifications/openapi/v3.1/understanding-structure/components.md) to keep the relevant parts of the example clear, but you can [learn more about schemas](_specifications/openapi/v3.1/data-models/schema-and-data-types.md) to see what else could go in there.
{: .info }
