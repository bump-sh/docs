...
canonical_url: https://docs.bump.sh/openapi/v3.2/understanding-structure/basic-structure/
date: 2024-07-02
---
...
It's fine to put any development and testing servers in here because you can always flag them as internal or [strip them out with overlays later](_specifications/openapi/v3.1/extending/overlays.md).
...
**Learn more about [paths & operations](_specifications/openapi/v3.1/understanding-structure/paths-operations.md).**
...
You can get into path specific overrides and various complex "and" situations with more [advanced security functionality](_specifications/openapi/v3.1/advanced/security.md).
