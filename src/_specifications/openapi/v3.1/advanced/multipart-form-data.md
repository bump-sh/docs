...
canonical_url: https://docs.bump.sh/openapi/v3.2/advanced/multipart-form-data/
date: 2024-08-06
---
...
> Multipart form data is only one way to handle file uploads, so read the [File Uploads](_specifications/openapi/v3.1/advanced/file-uploads.md) guide to see other ways to do it.
{: .info }
