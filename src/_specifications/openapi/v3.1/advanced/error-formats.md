...
canonical_url: https://docs.bump.sh/openapi/v3.2/advanced/error-formats/
date: 2024-08-07
---
...
If you need to handle errors responses in multiple content types, you can learn about [Multiple Content Types](_specifications/openapi/v3.1/advanced/multiple-content-types.md) and it's all the same.
