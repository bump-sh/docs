...
By combining [schema composition](_specifications/openapi/v3.2/data-models/schema-composition.md) and [references](_specifications/openapi/v3.2/advanced/splitting-documents-with-ref.md), it's possible to create reusable components that be used for both JSON and XML output, like this simplistic example below.
