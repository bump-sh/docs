...
> These responses contain shared schemas which are referenced via the [components section](_specifications/openapi/v3.2/understanding-structure/components.md) to keep the relevant parts of the example clear, but you can [learn more about schemas](_specifications/openapi/v3.2/data-models/schema-and-data-types.md) to see what else could go in there.
{: .info }
