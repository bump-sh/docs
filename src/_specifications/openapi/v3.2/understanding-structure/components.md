...
Hopefully this gives an idea of how `$ref` can be used, and if you'd like to learn more check out our advanced guide: [Splitting Documents with $ref](_specifications/openapi/v3.2/advanced/splitting-documents-with-ref.md).
