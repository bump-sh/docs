...
The `oneOf` is optional, but a handy use of [polymorphism](_specifications/openapi/v3.2/data-models/schema-composition.md) to describe different schemas for each event - which can really help with documentation and validation.
