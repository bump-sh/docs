...
If you need to handle errors responses in multiple content types, you can learn about [Multiple Content Types](_specifications/openapi/v3.2/advanced/multiple-content-types.md) and it's all the same.
